...
OUTPUT = WORK / "btxrd_biomedclip_layercam_proposal_gallery_val_v1"
SOURCE_REPOSITORY = "https://github.com/itsthang333/Thesis.git"
SOURCE_COMMIT = "c3845f78128bdad95aab909180f5ac701e713a10"
IMPLEMENTATION_COMMIT = "1f6847d9326d9e8a789e1924a3a2a7735f5a1f0f"
EXPECTED_PROTOCOL_SHA256 = "8b5883780df881ecb654ee9a6d431a56a175d560c41f34f0ca6170f8a54a8c1d"
...
EXPECTED_SOURCE_SHA256 = {
    "generate_pseudo_masks.py": "2470eddf73d2e717f654113d03c1a1829c73d16c1c44f555cc71484ab42c8f3d",
    "evaluate_saved_candidate_diagnostics.py": "a746da95b0e8bb6e8afde24d8ddee95d0b04692a4ee725aa4c57d0e627173f6a",
    "pseudo/candidate_diagnostics.py": "0ec601e723da317383a42a00ac64583b43bda6e856542a7b0ea2fcd247c18db3",
...
def checkout_source() -> tuple[Path, Path, Path]:
    ...
    protocol = (
        ...
        / "artifacts"
        / "research_protocols"
        / "biomedclip_layercam_proposal_gallery_val_v1.json"
    )
    ...
    if (
        parsed.get("status")
        != "predeclared_before_any_proposal_gallery_prediction"
...
def generation_command(
    ...
    return [
        ...
        "--selection-method", "coverage_mass_sam",
        "--fusion-topk", "1",
        "--component-topk", "3",
...
def main() -> None:
    ...
    if (
        ...
        or parameters.get("selection_method") != "coverage_mass_sam"
        or parameters.get("support_clip_kernel") != 5
    ):
        raise RuntimeError("Proposal-gallery generation contract mismatch")
    ...
    oracle_report = comparison["metrics"]["oracle_best_single_dice"]
    final_report = comparison["metrics"]["final_dice"]
    oracle_gate = (
        oracle_report["overall"]["ci95_low"] > 0.0
        and all(
            oracle_report["subgroups"][group]["ci95_low"] > 0.0
    ...
    comparison["protocol_promotion_gates"] = {
        "continue_selector_research": "PASS" if oracle_gate else "FAIL",
    ...
    manifest = {
        "run_id": "btxrd_biomedclip_layercam_proposal_gallery_val_v1",
