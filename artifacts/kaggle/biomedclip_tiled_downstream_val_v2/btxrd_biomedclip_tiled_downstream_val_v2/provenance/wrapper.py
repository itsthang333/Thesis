...
OUTPUT = WORK / "btxrd_biomedclip_tiled_downstream_val_v2"
SOURCE_REPOSITORY = "https://github.com/itsthang333/Thesis.git"
SOURCE_COMMIT = "c71c2f2e7b319b327c31e76e14a4828a17ac3b43"
IMPLEMENTATION_COMMIT = "37a10c95bdef1e4b3bf7c875379f9ef16f4ba9a8"
EXPECTED_PROTOCOL_SHA256 = "8f1fbbe273ed07b05f22401a651df42cde301540e2bda58267792b25bed84b56"
...
EXPECTED_SOURCE_SHA256 = {
    "generate_pseudo_masks.py": "da4c47fa6ec54665c1b2d7d603bfa04f103c1c84dbd42bb3ac8ae6d0a1c799ff",
...
def checkout_source() -> tuple[Path, Path, Path]:
    ...
    protocol = (
        ...
        / "artifacts"
        / "research_protocols"
        / "biomedclip_tiled_downstream_val_v2.json"
    )
    ...
    if (
        parsed.get("status")
        != "predeclared_after_saliency_gate_pass_before_downstream_prediction"
...
def main() -> None:
    ...
    manifest = {
        "run_id": "btxrd_biomedclip_tiled_downstream_val_v2",
