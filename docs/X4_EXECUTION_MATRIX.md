...
accounts.  Corrected seed42/43 v4 jobs are running, and seed44 is staged.
...
| X7 | Seeds 42/43/44 for CAM, PuzzleCAM, S2C, Rich Gallery and fully supervised | 11/15 required seed results are evaluated: CAM 3/3, PuzzleCAM 3/3 and Fully 3/3; S2C 2/3 plus seed43 running; Rich 0/3 with all three students running. | Running/evaluation | Finish S2C43 and the three Rich freezes/evaluations, then report the complete mean plus sample SD table. |
