...
| `wanwin` | `btxrd-x4-fully-seed42-prediction-freeze` v1 | X1 freeze 371 fully-supervised seed-42 predictions before outer spatial GT | Running |
...
| `itsthang333` | `btxrd-x4-fully-seed44-prediction-freeze` v1 | X1 freeze 371 fully-supervised seed-44 predictions before outer spatial GT | Running |
...
|---|---|---|---|---|
| X1 | Direct Rich Gallery versus Rich-Gallery pseudo-U-Net versus matched fully-U-Net | Direct Rich Gallery validation evidence exists in the frozen final/G4 artifacts. Common student trainer, prediction freezer and native evaluator are implemented. All three fully-supervised trainings completed; prediction freezes 42/44 run. Rich target audit passed and Rich students 42/43/44 run. | Partial | Audit/freeze/evaluate both three-seed arms on the same native grid. |
