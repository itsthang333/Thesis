...
E1, E3, E4, E6b and source-correct E7 are complete. Until exact E5 finishes,
the safest defense wording is: the current final system is the best
**validation-selected configuration among the completed declared arms**, while
exact gallery-construction necessity remains under experimental verification.
E6b specifically shows that no declared retrained G1 family improves the
fixed baseline on its predeclared three-seed mean.
