...
| E3 | Why SAM ViT-B? | ViT-B/L/H end-to-end | Inputs, prompts, multimask, gallery merge/dedup/cap, G1, fusion | Selected/oracle Dice, subgroups, seconds/image, peak VRAM, disk | B/L independently audited: Dice 0.288729/0.291185; paired delta +0.002456, CI `[-0.020021,0.024824]`. L costs 1.84x total wall time and 1.57x peak allocated VRAM. H is running; final backbone conclusion remains pending. |
