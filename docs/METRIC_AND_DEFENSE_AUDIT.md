...
E1, E3, E4 and source-correct E7 are complete. Until exact E5 and E6b
finish, the safest defense wording is: the current final system is the best
**validation-selected configuration among the completed declared arms**, while
gallery-construction and G1-design necessity remain under experimental
verification.
