...
| E3 | Why SAM ViT-B? | ViT-B/L/H end-to-end | Inputs, prompts, multimask, gallery merge/dedup/cap, G1, fusion | Selected/oracle Dice, subgroups, seconds/image, peak VRAM, disk | Frozen B/L/H Dice is 0.288729/0.291185/0.279212 and oracle is 0.528298/0.546000/0.510446. B/L are independently audited; H payload audit is pending. L's paired delta over B is only +0.002456, CI `[-0.020021,0.024824]`, at 1.84x total wall time and 1.57x peak allocated VRAM. |
