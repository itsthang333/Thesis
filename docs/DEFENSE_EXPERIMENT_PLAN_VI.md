...
| E3 | Vì sao SAM ViT-B? | ViT-B/L/H giữ nguyên source maps, prompts, gallery, selector | Dice, oracle, subgroup, runtime, peak VRAM, disk | B/L đã audit độc lập: Dice 0.288729/0.291185, paired delta +0.002456 với CI `[-0.020021,0.024824]`; L tốn 1.84x tổng thời gian và 1.57x peak allocated VRAM. H đang chạy. Chưa kết luận cuối trước H. |
