...
| E5 | Vì sao rich gallery và cap 243? | upstream top-1; một exact prompt; 3 SAM multimasks; pre-dedup union; post-dedup; caps 27/81/162/243 | selected Dice, oracle, Recall@Dice, cost | Hoàn tất/audit pass. Native Dice của upstream top-1/single-mask/three-multimask/pre-dedup/post-dedup/cap243 là 0.222746/0.219017/0.219600/0.288139/0.288224/0.288224. Rich gallery tăng khoảng 0.0686 Dice so với một prompt; ba multimask chỉ tăng 0.00058 so với một mask. Dedup gần như không đổi (+0.000085), còn cap243 không cắt thêm candidate nào trong cohort này. |
...
3. **E3 ViT-B/L/H:** cùng seed/protocol, bao gồm peak VRAM, wall time, artifact
   ...
   chính xác hơn.
4. **E5 exact construction:** đã hoàn tất với exact `prompt_id` và
   `multimask_index`; cùng một prompt được khóa cho single-mask và multimask,
   lựa chọn được đóng băng trước khi mở polygon, không dùng prompt-mode thay thế.
