...
| E3 | Vì sao SAM ViT-B? | ViT-B/L/H giữ nguyên source maps, prompts, gallery, selector | Dice, oracle, subgroup, runtime, peak VRAM, disk | Cả ba run đã xong: Dice B/L/H = 0.288729/0.291185/0.279212; oracle = 0.528298/0.546000/0.510446. B/L audit độc lập xong; H còn bước audit payload cuối. L chỉ hơn B +0.002456 với CI `[-0.020021,0.024824]` nhưng tốn 1.84x thời gian và 1.57x peak VRAM, nên chưa có bằng chứng thay B. |
