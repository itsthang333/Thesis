...
SOURCE = ROOT / "project" / "kaggle_wrappers" / "run_mask_bag_critical_relation_r3_v1.py"


def test_r3_wrapper_is_fail_closed_and_gt_free() -> None:
...
def test_r3_wrapper_binds_transport_t4x2_and_all_physical_outputs() -> None:
    source = SOURCE.read_text(encoding="utf-8")
    for required in (
        ...
        "critical_relation_residual.pt",
        "pretraining_identity_audit.json",
