"""Static, no-input prelaunch audit for the S8 audit-only dataset correction."""
...
def audit(package: Path, repository_root: Path) -> dict[str, object]:
    ...
    replacements = {
        b"KERNEL_VERSION = 2": b"KERNEL_VERSION = 0",
    ...
    return {
        "schema_version": 1,
        "status": "S8_AUDIT_ONLY_V2_FROZEN_PRELAUNCH_PASS",
        "kernel": KERNEL,
        "kernel_version": 2,
